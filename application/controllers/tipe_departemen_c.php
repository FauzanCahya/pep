...
class Tipe_departemen_c extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('tipe_departemen_m','depart');
	...
	public function index()
	{
		$data = array(
				...
				'page'  	 => 'tipe_departemen_v',
				'sub_menu' 	 => 'master data',
				'sub_menu1'	 => 'master departemen',
				'menu' 	   	 => 'master_data',
				'menu2'		 => 'departemen',
				'lihat_data' => $this->depart->lihat_data_depart(),
				'url_simpan' => base_url().'tipe_departemen_c/simpan',
				'url_hapus'  => base_url().'tipe_departemen_c/hapus',
				'url_ubah'	 => base_url().'tipe_departemen_c/ubah_depart',
			);
