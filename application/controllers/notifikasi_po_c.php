...
class Notifikasi_po_c extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('notifikasi_po_m','notifikasi');
	...
	public function index()
	{
		$data = array(
				...
				'url_simpan' => base_url().'Notifikasi_po_c/simpan',
				'url_hapus'  => base_url().'Notifikasi_po_c/hapus',
				'url_ubah'	 => base_url().'Notifikasi_po_c/ubah_notifikasi',
			);
