...
class Pengeluaran_bank_c extends CI_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->load->model('pengeluaran_bank_m','model');
	...
	public function index()
	{
		...
		$data = array(
				...
				'url_hapus'  		=> base_url().'pengeluaran_bank_c/hapus',
