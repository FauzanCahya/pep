...
function add_row(kode_barang,nama_produk,satuan,no_spb){
	var jml_tr = $('#jml_tr').val();
	var i = parseFloat(jml_tr) + 1;
                ...
                if(result.length > 0){
                    $.each(result,function(i,res){
                        ...
                        isine += '<tr>'+
                                    ...
                                    '<td>'+
                                    	'<button style="width: 100%;" onclick="add_row(&quot;'+res.kode_barang+'&quot;,&quot;'+res.nama_barang+'&quot;,&quot;'+res.satuan+'&quot;,&quot;'+res.no_spb+'&quot;);" type="button" class="btn btn-success"> Tambah </button>'+
                                    '</td>'+
                                '</tr>';
                    });
                } else {
