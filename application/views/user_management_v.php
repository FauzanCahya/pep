...
$(document).ready(function(){
	...
	$("#tambah_user_management").click(function(){
		$("#tambah_user_management").fadeOut('slow');
		$("#table_user_management").fadeOut('slow');
		$("#form_user_management").fadeIn('slow');
	});

	$("#batal").click(function(){
		$("#tambah_user_management").fadeIn('slow');
		$("#table_user_management").fadeIn('slow');
		$("#form_user_management").fadeOut('slow');
	});
});
...
function hapus_user_management(id)
{
	...
	$('#popup_hapus').show();
		...
		$.ajax({
		url : '<?php echo base_url(); ?>user_management_c/data_user_management_id',
		data : {id:id},
		type : "POST",
		dataType : "json",
		async : false,
...
function ubah_data_user_management(id)
{
...
<div class="row" id="form_user_management" style="display:none;">
	<div class="col-md-12">
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-haze">
					...
					<span class="caption-subject bold uppercase"> Form User Management </span>
				</div>
				<div class="actions">
...
<button id="tambah_user_management" class="btn green">
Tambah Data user_management <i class="fa fa-plus"></i>
</button>
</br>
</br>

<div class="row" id="table_user_management" style="display:block; ">
	<div class="col-md-12">
		<!-- BEGIN EXAMPLE TABLE PORTLET-->
		<div class="portlet box green">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-edit"></i>Table User Management
				</div>
				<div class="tools">
		...
		<div class="tab-content">
			<div id="tab_0" class="tab-pane active">
				<div class="portlet box green">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-pencil"></i>Ubah user_management
						</div>
					</div>
					...
					<form role="form" class="form-horizontal" method="post" action="<?php echo $url_ubah;?>" enctype="multipart/form-data">
						<div class="form-body">
							<input type="hidden" name="id_user_management_modal" id="id_user_management_modal">
