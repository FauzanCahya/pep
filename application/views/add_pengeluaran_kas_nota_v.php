				...
				<form role="form" class="form-horizontal" method="post" action="<?php echo $url_simpan; ?>">
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="no_pm" name="no_pm" readonly>
								<button>ads</button>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<textarea class="form-control" name="untuk" style="height: 100px;" readonly></textarea>
							</div>
						</div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tfoot>
                            	<tr>
                            		...
                            		<td style="text-align: right;"><b id="total_debet_txt">800.000</b></td>
                            		<td style="text-align: right;"><b id="total_kredit_txt">800.000</b></td>
