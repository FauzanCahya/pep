...
<table style="width: 100%">
	...
	<tr>
		...
		<td style="width: 15%;text-align: right;border: 1px solid black;"><?=$dt->id_order;?></td>
	</tr>
</table>
    ...
    <tr>
        <td align="center">
            <h4 style="text-decoration: underline;">
                ORDER PEMBELIAN BARANG (OPB)
            </h4>
            <label><?=$dt->no_opb;?></label>
        </td>
    </tr>
</table>
<br>
...
<table style="width: 100%;height: 300px;">
		...
		<tr>
			...
			<!-- <th style="width: 5%;padding: 5px 5px 5px 5px; border-top: 1px solid black; border-bottom: 1px solid black;border-right: none;border-left: none;">Shift</th> -->
			<th style="width: 7%;padding: 5px 5px 5px 5px; border-top: 1px solid black; border-bottom: 1px solid black;border-right: none;border-left: none;">Jumlah</th>
			...
			<th style="width: 20%;padding: 5px 5px 5px 5px; border-top: 1px solid black; border-bottom: 1px solid black;border-right: none;border-left: none;">No SPB</th>
		</tr>
...
<label>Catatan Stock/Gudang</label>
<br>
<div style="height: 300px;">
<table style="width: 100%;">
	<tr>
			<th style="width: 5%;padding: 5px 5px 5px 5px; border-top: 1px solid black; border-bottom: 1px solid black;border-right: none;border-left: none;">No</th>
			<th style="width: 30%;padding: 5px 5px 5px 5px; border-top: 1px solid black; border-bottom: 1px solid black;border-right: none;border-left: none;">Buffer Stock</th>
			<th style="width: 15%;padding: 5px 5px 5px 5px; border-top: 1px solid black; border-bottom: 1px solid black;border-right: none;border-left: none;">Posisi Stock Saat Ini</th>
			<th style="width: 15%;padding: 5px 5px 5px 5px; border-top: 1px solid black; border-bottom: 1px solid black;border-right: none;border-left: none;">Supplier</th>
			<th style="width: 35%;padding: 5px 5px 5px 5px; border-top: 1px solid black; border-bottom: 1px solid black;border-right: none;border-left: none;">Prakiraan Harga</th>
		</tr>
</table>
</div>
...
<br>
<label>Tembusan Kepada : 1.Bag Gudang  2. Acounting 3. Arsip Kabag Pemakal</label>
...
<?PHP
    ...
    $html2pdf->pdf->SetTitle('Laporan Order Pembelian');
